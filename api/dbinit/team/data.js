        ...
        content: [
          {
            d1: `
              ...
              변화를 찾을 수 있다. 화려할 때도, 소소할 때도 있지만 영화가 여러 장면의 연결로 완성되는 것처럼 우리가 마주하게 되는 거리들 또한 하루를 구성하는 장면들인 셈이다. /n /n
          ...
          },
          {
            d6: `
              ...
              시작하기로 마음을 먹었고, 현재는 온/오프라인에서 활발하게 활동하고 있는 친구들입니다. 코에오 매장과 아주 가까운 곳에 쇼룸 겸 작업실을 오픈했습니다." /n /n
        ...
        content: [
          {
            d1: `
              ...
              묶여서 자연스럽게 표현될 수 있었던 배경은 무엇일까? 겨울과 봄의 경계인 2월의 어 하루 연필을 직접 다녀왔다. /n /n
          ...
          },
          {
            d2: `
              ...
              사물 등을 이중적인 의미로 지어보는 것도 좋겠다.'라는 생각이 번쩍 들었습니다. 또 때마침 '연필'이란 단어가 떠올랐죠." /n /n
          ...
          },
          {
            d5: `
              ...
              "대부분 커피와 공간에 대한 내용들이 많이 적혀 있는데, 그 메모를 볼 때마다 내심 열심히 일을 한 것 같아 마음이 따뜻해지고 더 분발해야겠다는 느낌을 강하게 받습니다. 또 그림도 많이 그려
              주시는데, 특히 연필의 창밖으로 자주 출몰하는 길 고양이를 그려주시는 분들이 정말 많아요. 고양이의 생김새는 한결같지만 손님들이 그리는 고양이들은 다양한 특징들을 갖고 있어 볼 때마다
              사람들마다 다양한 관점을 가지고 있고 관찰력이 다르다는 것을 느끼게 되는 것 같아 재미있고 신기한 것 같아요." /n /n
        ...
        content: [
          ...
          },
          {
            d5: `
              ...
              알리고 있다. 디저트에 강점을 두고 있는 카페인만큼 다양한 디저트들과 함께 즐길 수 있는 시즌별 시그니처 메뉴를 만나볼 수 있다는 것이 포인트다. /n 
          ...
          },
          {
            d6: `
              ...
              비롯해 직원들 모두의 수준 높은 라떼아트를 즐길 수 있는 라떼 메뉴들은 긍정적인 후기로 가득하다. /n /n
        ...
        content: [
          {
            d1: `
              ...
              바리스타를 만나 그간의 이야기와 새로운 소식들을 전해 들어봤다. /n /n
			
			        2018년에 처음으로 오픈한 아이덴티티커피랩은 올해로 5년 차 브랜드다. 첫 매장은 카페의 역할만 하는 공간으로 시작했지만 3년 전부터는 납품도 본격적으로 시작했다. /n /n
			
			        “처음에는 가정용에 가까운 작은 로스터기로만 시작했어요. 1년 정도 운영을 하다가 망원동으로 옮겼는데, 그때 로스터리 카페 브랜드로 더 방향성을 확실하게 잡았죠. 그 이후로 거래처가 많이
              유입이 됐고, 그에 따라 운영도 점차 본격적으로 하면서 제조에 더 집중을 하게 됐어요.” /n /n
          ...
          },
          {
            d5: `
              ...
              것이다. 그리고 이를 통해 스페셜티커피 문화를 지속하는데 도움이 되는 방향을 추구한다. /n /n
			        ...
			        인터뷰를 하면서 마신 커피는 '코스타리카 하시엔다 코페이 이타다키 게이샤 블랙 허니'였다. 아이덴티티커피랩의 하이엔드 커피 라인업이라고 할 수 있는 브릴리언트(Brilliant) 라인 커피였다. /n /n
        ...
        content: [
          ...
          },
          {
            d3: `
              ...
              이후 카페 오픈을 준비하면서 키헤이라는 이름을 그대로 브랜드 명으로 사용했다. /n /n
			  
			        “단순히 저희가 그곳에서 좋은 기억과 경험들을 할 수 있었던 것처럼, 우리 카페를 찾아주시는 분들도 좋은 기억, 작은 행복이라도 소중하게 남길 수 있기를 바라는 마음이었어요.” /n /n
          ...
          },
          {
            d6: `
              ...
              같은 개념으로, 한 번에 15잔 정도 분량을 내려서 제공하고 있는데, 많은 고객들이 믿고 선택하는 메뉴라고. /n /n
        ...
        content: [
          {
            d1: `
              ...
              에디터/포토 지우탁 /n /n
			        ...
			        처음부터 로스팅 오피스를 마련할 정도로 다양한 라인업에 커피들이 폰트의 이름으로 소개 및 판매되고 있었고, 직접 방문한 산지를 비롯한 커피 업계 자체에 대한 정보들도 꾸준히 전해오고 있었다. /n /n
          ...
          },
          {
            d3: `
			        ...
			        이를 감안하면 지금의 폰트가 만들어지기까지 치밀한 준비와 노력이 있었음을, 그리고 오랜 기간 커피업계에서 종사하며 축적한 두 대표의 노련한 운영이 있었음을 짐작해 볼 수 있다. /n /n
          ...
          },
          {
            d5: `
              ...
              이"커피는 각성제의 역할을 하던 이전과는 달리, 이제 현대인의 삶에서 빠질 수 없는 음료가 되었습니다. 소비자들은 더 빠르게 마실 수 있는 것보다 더 맛있게 마실 수 있는 것을 찾죠. 
			        당연히 커피를 맛있게 만들 수 있는 전문가들을 필요로 하고, 이들은 커피와 사람을 잇는 다리의 역할을 하게 됩니다." /n /n
          ...
          },
          {
            d6: `
              "커피를 찾는 이들에게 좋은 품질의 커피를 널리 알리고, 그 수익이 선순환으로 이어지면서 폰트와 연결되어 있는 모든 사람들의 삶의 질을 높일 수 있도록 하는 가치 있는 소비를 만들고 있어요. 
			        ...
			        더 높은 가격을 지불하는 것이 더욱 가치 있는 소비를 했다는 자부심이나 만족감을 줄 수 있어야 한다고 생각합니다." /n /n
          ...
          },
          {
            d7: `
			        ...
			        다른 화려한 목표에 여러 수식어로 자신들의 비전을 표현하는 브랜드들에 비하면 단순하고 현실적이라고 보일 수 있겠지만 그래서 오히려 사람들이 폰트에 보내는 애정은 더욱 선명하고 진하다. /n /n
			  
			        "단순히 돈을 많이 벌어서 큰 성장을 이루는 것이 목표는 아닙니다. 돈은 손님들에게 폰트가 지속적으로 선택받을 수 있게 하는 힘을 만들고, 구성원들의 삶을 영위할 수 있도록 하는 수단으로 사용될 거예요. 
			        많은 분들께서 사랑해 주신 덕에 잘 살아남았습니다. 앞으로도 최선을 다해 살아남겠습니다. 감사합니다." /n /n
			  
			        폰트(PONT) /n
			        로스팅 오피스 | 서울 영등포구 도림로139길 21 /n
        ...
        content: [
          {
            d1: `
              ...
              Higher Standard Solid System, 스탠다드시스템 /n /n
          ...
          },
          {
            d5: `
			        ...
			        벗어나는 결과물들은 폐기한다. 그만큼 품질 관리에 무척 까다롭다. /n /n
          ...
          },
          {
            d7: `
              ...
              접했을 때 그들이 전달하고자 하는 커피의 맛을 명료하게 이해할 수 있기를 바랐기 때문인데, 내부적으로 커피를 평가할 때 기준으로 하는 6가지 항목의 그래프를 삽입한 의도 또한 커피의 맛에 대해 보다 구체적으로 전하고 소통하기 위함이다. /n /n
        ...
        content: [
          {
            d1: `
              ...
              영도의 새로운 랜드마크, P.ARK(피아크) /n /n
			  
              에디터/포토 지우탁 /n /n
			  
			        부산에서도 현재 커피로 가장 뜨거운 주목을 받고 있는 지역이 바로 영도다. 다른 지역에 비해 비교적 사람들의 관심도, 유동인구도 적던 지역이었지만 
              최근 빠르게 활기를 띄고 있는 것. 커피 축제가 열리는 등 다양한 요소들로 인해 사람들의 이목이 쏠리고 있는데 그중 가장 많은 관심과 시선을 받고 있는 곳이 바로 P.ARK(피아크)다. /n /n
          ...
          },
          {
            d4: `
              ...
              궁극적으로는 부산 사람이나 관광객 모두 찾을 수 있는 문화 공간이 있다면 영도는 물론이고 부산을 대표하는 랜드마크가 될 수 있다고 본 것이다. /n /n
          ...
          },
          {
            d6: `
              ...
              피아크의 다양한 베이커리와 최고의 밸런스를 이루기 때문. /n /n
